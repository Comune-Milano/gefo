package it.dmi.dmifon.config;

import static org.springframework.security.web.server.util.matcher.ServerWebExchangeMatchers.pathMatchers;

import com.github.benmanes.caffeine.cache.Cache;
import com.github.benmanes.caffeine.cache.Caffeine;
import it.dmi.dmifon.security.AuthoritiesConstants;
import it.dmi.dmifon.security.SecurityUtils;
import it.dmi.dmifon.security.oauth2.AudienceValidator;
import it.dmi.dmifon.security.oauth2.JwtGrantedAuthorityConverter;
import it.dmi.dmifon.web.filter.SpaWebFilter;
