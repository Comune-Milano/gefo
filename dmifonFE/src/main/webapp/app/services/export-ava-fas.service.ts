...
export class ExportAvaFasService {
  ...
  exportAvanzamenti(param: any): Observable<any> {
    return this.http
      .post(`services/dmifonbe/api/exportAvanzamenti/exportAvanzamenti?idUteRuo=${this.accountService.getCurIdUteRuo()}`, param, {
        headers: { skip: 'true' },
      })
      .pipe(
        catchError(err => {
