...
export class ExportCapitoliService {
  ...
  exportCapitoli(param: any): Observable<any> {
    return this.http
      .post(`services/dmifonbe/api/exportCapitoli/exportCapitoli?idUteRuo=${this.accountService.getCurIdUteRuo()}`, param, {
        headers: { skip: 'true' },
      })
      .pipe(
        catchError(err => {
