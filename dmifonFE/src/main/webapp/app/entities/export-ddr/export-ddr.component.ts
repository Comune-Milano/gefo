...
@Component({
  ...
  templateUrl: './export-ddr.component.html',
  styleUrls: ['./export-ddr.component.scss'],
})
export class ExportDdrComponent extends UpdatePage implements OnInit {
  ...
  sendExport(): void {
    if (this.formExport.valid) {
      ...
      this.exportComponent.exportEntity = 'DDR';
