...
@Component({
  ...
  templateUrl: './export-acce-impe.component.html',
  styleUrls: ['./export-acce-impe.component.scss'],
})
export class ExportAcceImpeComponent extends UpdatePage implements OnInit {
  ...
  createExportObj(): any {
    const exportObj = {
      ...
      flgSolImpPro: this.formExport.get('flgSolImpPro')?.value ? this.formExport.get('flgSolImpPro').value : null,
    };
    return exportObj;
  }
  ...
  sendExport(): void {
    if (this.formExport.valid) {
      ...
      this.exportComponent.exportEntity = 'IMP';
