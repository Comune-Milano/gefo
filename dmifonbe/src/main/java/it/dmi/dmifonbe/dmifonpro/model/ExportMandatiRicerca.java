...
@JsonSerialize
public class ExportMandatiRicerca implements Serializable {
    ...
    private Integer annEse;
    private Date dtaPagDa;
    private Date dtaPagA;

    public Integer getAnnEse() {
        return annEse;
    }

    public void setAnnEse(Integer annEse) {
        this.annEse = annEse;
    }

    public Date getDtaPagDa() {
        return dtaPagDa;
    }

    public void setDtaPagDa(Date dtaPagDa) {
        this.dtaPagDa = dtaPagDa;
    }

    public Date getDtaPagA() {
        return dtaPagA;
    }

    public void setDtaPagA(Date dtaPagA) {
        this.dtaPagA = dtaPagA;
    }
