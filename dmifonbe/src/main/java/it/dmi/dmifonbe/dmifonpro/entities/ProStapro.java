...
@Entity
@Table(name = "pro_stapro", schema = "dmifonpro", catalog = "dmifon")
@JsonIdentityInfo(generator = JSOGGenerator.class)
public class ProStapro extends EntitySuperClass {
    ...
    @OneToMany(mappedBy = "proStaproByIdStapro", fetch = FetchType.LAZY)
    @Valid
    ...
    public boolean equals(Object o) {
        ...
        ProStapro proStapro = (ProStapro) o;

        if (id != proStapro.id) return false;
        if (dessta != null ? !dessta.equals(proStapro.dessta) : proStapro.dessta != null) return false;
        if (tipsta != null ? !tipsta.equals(proStapro.tipsta) : proStapro.tipsta != null) return false;
