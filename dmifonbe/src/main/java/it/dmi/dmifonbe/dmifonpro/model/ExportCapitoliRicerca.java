...
@JsonSerialize
public class ExportCapitoliRicerca implements Serializable {
    ...
    private boolean flgCapEnt;

    public boolean isFlgCapEnt() {
        return flgCapEnt;
    }

    public void setFlgCapEnt(boolean flgCapEnt) {
        this.flgCapEnt = flgCapEnt;
    }
